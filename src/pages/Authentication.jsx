...
import stockpolice from '../assets/home-logo.png'
import {
  PushNotifications,
...
function Authentication(props) {
  ...
  const {userLoggedIn, setUserProfileData, isUserLoggedIn, setDeviceTokenCookie} = useContext(AuthContext)
  ...
  const verifyOtp = async(data) => {
    ...
    try {
      ...
      await userLoggedIn(userProfile.mobileNo, userProfile.role, userProfile)
